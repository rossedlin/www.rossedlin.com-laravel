...
<link rel="stylesheet"
      href="<?= Cryslo\Core\Utils::addVersionToCssFile('/theme/ross-edlin/css/theme/' . config('site.theme') . '.css') ?>">
<link rel="stylesheet"
      href="<?= Cryslo\Core\Utils::addVersionToCssFile('/theme/ross-edlin/css/theme.css') ?>">
